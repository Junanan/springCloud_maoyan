...
public class EntityGenerator {
    ...
    private String outputDir = "D:\\backend-parent\\backend_common\\src\\main\\java";
    // 生成类的作者
    private String author = "junnan";
    // 数据源相关配置
    ...
    // DAO的包路径
    private String daoPackage = "com.meetingfilm.backendcommon";
    // 待生成的表名，注意是覆盖更新
